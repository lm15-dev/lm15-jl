...
const PROVIDERS = Dict{String,ProviderSpec}(
    ...
    "meta" => spec(env_keys = ["META_API_KEY"]),
    "meta-chat" => spec(env_keys = ["META_API_KEY"]),
    "meta-anthropic" => spec(env_keys = ["META_API_KEY"]),
    "moonshotai" => spec(env_keys = ["MOONSHOTAI_API_KEY", "MOONSHOT_API_KEY"]),
    "moonshotai-responses" => spec(env_keys = ["MOONSHOTAI_API_KEY", "MOONSHOT_API_KEY"]),
    "moonshotai-anthropic" => spec(env_keys = ["MOONSHOTAI_API_KEY", "MOONSHOT_API_KEY"]),
